...
keyFacts:
  ...
  - { label: "Local transport", value: "Metro, tram, cable cars, taxis" }
  - { label: "Languages", value: "Arabic, Tamazight, French" }
  - { label: "Best time", value: "Apr–Jun & Sep–Nov" }

unesco: ["Casbah of Algiers"]
sameAs: ["https://en.wikipedia.org/wiki/Algiers"]
featuredAttractions: ["casbah-of-algiers"]
featuredArticles: ["algerian-food-guide","algeria-safety-guide"]
faqs:
  - { q: "Is the Casbah of Algiers safe to visit?", a: "Yes, by day and ideally with a local guide. The Casbah is a steep, dense maze of Ottoman alleys; a guide helps you navigate, find the restored houses and palaces, and read the history. Take normal city precautions, wear sturdy shoes and dress modestly." }
  - { q: "What is Algiers famous for?", a: "Its UNESCO Casbah; the white tiered waterfront that earns the nickname 'Alger la Blanche'; the enormous modern Great Mosque of Algiers; the clifftop basilica of Notre-Dame d'Afrique; Ottoman mosques like Ketchaoua; and the towering Maqam Echahid (Martyrs' Memorial)." }
  - { q: "How many days do you need in Algiers?", a: "Two to three days covers the Casbah, the colonial centre and seafront, the main museums and monuments, and a half-day along the coast or a day trip to the Roman ruins of Tipaza." }
  - { q: "Is Algiers walkable, and how do I get around?", a: "The colonial centre and seafront are very walkable and the Casbah is walkable but steep. The wider city is large, so use the metro and tram, the cable cars up to the heights, or taxis between districts; hire a driver for excursions." }
  - { q: "What is the Great Mosque of Algiers?", a: "Djamaâ el Djazaïr is a vast modern mosque on the bay, among the largest in the world and home to one of the tallest minarets anywhere. It's a striking counterpoint to the historic Ottoman and colonial city and worth seeing for its scale alone." }
  - { q: "Can I do a day trip to Tipaza from Algiers?", a: "Yes — Tipaza, with its Roman ruins beside the sea (also UNESCO-listed) and the nearby Royal Mausoleum of Mauretania, lies about an hour west and is one of the best easy excursions from the capital." }
  - { q: "When is the best time to visit Algiers?", a: "April–June and September–November are most pleasant — warm, clear and good for walking. July–August are hot, humid and busy along the coast; winters are mild but can be wet." }
  - { q: "Do I need to dress conservatively in Algiers?", a: "Algiers is relatively cosmopolitan, but it's still respectful to dress modestly, especially in the Casbah and at mosques. Ask before photographing residents, particularly in the old city." }
...
sources:
  - { title: "Kasbah of Algiers", publisher: "UNESCO World Heritage Centre", url: "https://whc.unesco.org/en/list/565/", type: "unesco" }
  - { title: "Algiers", publisher: "Encyclopaedia Britannica", url: "https://www.britannica.com/place/Algiers", type: "reference" }
primaryCluster: "algeria-architecture"
cluster: "algeria-architecture"
secondaryClusters: ["algeria-unesco", "algeria-history", "algeria-culture"]
intent: "navigation"
---
---
