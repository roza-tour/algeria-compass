...
keyFacts:
  ...
  - { label: "Wilaya number", value: "19" }
  - { label: "Provincial capital", value: "Sétif (ancient Sitifis)" }
...
faqs:
  ...
  - { q: "Is Sétif safe for tourists?", a: "Yes. Sétif is a calm university and commercial city and the wider province is considered safe for normal travel. Carry ID for routine highland checkpoints, take standard city precautions, and dress modestly in this conservative interior region." }
  ...
  - { q: "Where should I eat near Djémila?", a: "Eating options at the site are simple, so bring water and a snack for the ruins. For a proper meal, eat in Sétif city, which has the province's widest choice of grills, rotisserie and patisseries." }
