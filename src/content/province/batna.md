...
keyFacts:
  - { label: "State number", value: "5" }
  - { label: "Capital", value: "Batna" }
  - { label: "Region", value: "Aurès mountains, eastern highlands" }
  - { label: "UNESCO site", value: "Timgad (inscribed 1982)" }
  - { label: "Culture", value: "Chaoui (Amazigh)" }
  - { label: "Best time", value: "Apr–Jun & Sep–Oct" }

unesco: ["Timgad"]
sameAs: ["https://en.wikipedia.org/wiki/Batna_Province"]
faqs:
  - { q: "What is Batna known for?", a: "It is the gateway to the Aurès mountains and the home of Timgad, the UNESCO Roman city often called 'the Pompeii of Africa'. The state is also the heartland of the Chaoui Amazigh and holds the pre-Roman royal mausoleum of Imedghassen." }
  - { q: "How do I get to Timgad?", a: "Timgad is about 35 km east of Batna city, an easy drive, and is the main reason most travellers visit the state. Batna has an airport with domestic flights and sits on the eastern road and rail network." }
  - { q: "What are the Aurès mountains?", a: "A rugged massif of gorges, cedar forests and Chaoui villages south of Batna — a stronghold of Amazigh culture and a scenic region with deep historical significance in Algeria's independence war." }
  - { q: "Is Batna worth more than a day?", a: "Timgad itself is a half-day, but pairing it with Imedghassen and a drive into the Aurès gorges easily fills a rewarding day or two." }
...
sources:
  ...
  - { title: "Batna", publisher: "Encyclopaedia Britannica", url: "https://www.britannica.com/place/Batna", type: "reference" }
primaryCluster: "algeria-history"
cluster: "algeria-history"
secondaryClusters: ["algeria-unesco", "algeria-mountains"]
intent: "navigation"
---
