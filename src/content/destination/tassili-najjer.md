...
keyFacts:
  - { label: "Type", value: "Plateau & rock-art site (UNESCO 1982)" }
  - { label: "Location", value: "Near Djanet, south-east Algeria" }
  - { label: "Rock art", value: "~15,000 engravings & paintings" }
  - { label: "Access", value: "4x4 + trekking, licensed guides, permits" }
  - { label: "Best time", value: "November–February" }

faqs:
  - { q: "What is Tassili n'Ajjer famous for?", a: "Its prehistoric rock art — around 15,000 images spanning thousands of years — and its dramatic eroded sandstone landscape of 'forests of rock', recognised by UNESCO in 1982." }
  - { q: "How do you visit Tassili n'Ajjer?", a: "From Djanet, on organised trips using licensed guides and 4x4 vehicles, with permits for the deep-desert zones. The cool season (November–February) is the time to go." }
