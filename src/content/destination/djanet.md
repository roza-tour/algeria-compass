...
keyFacts:
  ...
  - { label: "Gateway to", value: "Tassili n'Ajjer, Tadrart Rouge" }
  - { label: "Access", value: "Domestic flights + 4x4" }
  - { label: "Best season", value: "November–February" }
  - { label: "Permits", value: "Required for deep-desert zones" }

faqs:
  - { q: "How do you get to Djanet?", a: "By domestic flight from Algiers (with connections), then 4x4 for the desert. Deep-desert travel uses licensed guides and permits." }
  - { q: "What is there to see around Djanet?", a: "The Tassili n'Ajjer rock-art plateau, the red dunes and arches of the Tadrart Rouge, and Tuareg desert culture." }
