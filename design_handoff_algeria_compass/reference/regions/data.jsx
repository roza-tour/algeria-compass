/* Algeria Compass — REGIONS · the 8 طبوع (data) */
...
const REGIONS = [
  {
    ...
    hero: T + 'algiers-9.jpg', emblem: '../../assets/regions/em-algiers.svg', pat: "url('../../assets/regions/pat-algiers.svg')",
    ...
    intro: ['Algiers rises from the bay in a cascade of white — “Alger la Blanche”. Its old heart, the Casbah, is a UNESCO-listed maze of Ottoman houses, mosques and courtyards still lived in today, climbing steeply from the harbour to the citadel above.', 'Below it spreads the French colonial city of arcaded boulevards, and beyond, the gardens, monuments and museums of a capital that has been Phoenician, Roman, Ottoman and French in turn.'],
    monuments: [
  ...
  },
  {
    ...
    hero: T + 'constantine-1.jpg', emblem: '../../assets/regions/em-constantine.svg', pat: "url('../../assets/regions/pat-constantine.svg')",
    ...
    intro: ['Few cities have a setting like Constantine. The old town sits on a plateau all but encircled by the Rhumel, which has cut a gorge so deep the city seems to float, joined to the plateau by a famous sequence of bridges.', 'Long before the Ottomans this was Cirta, capital of the Numidian king Massinissa, later refounded by the emperor Constantine. Two thousand years on it remains the cultural capital of the Algerian east — and the home of malouf, its Andalusian classical music.'],
    monuments: [
  ...
  },
  {
    ...
    hero: T + 'djemila-1.jpg', emblem: '../../assets/regions/em-roman.svg', pat: "url('../../assets/regions/pat-roman.svg')",
    ...
    intro: ['Rome ruled North Africa for six centuries, and nowhere left finer cities than in Algeria. On a remote upland in Sétif, Djémila (Cuicul) survives almost intact: paved streets, temples, a theatre and a museum of brilliant mosaics.', 'South across the Aurès, Timgad was laid out by the emperor Trajan as a perfect grid — “the Pompeii of Africa”. On the coast, Tipaza’s ruins stand among wildflowers above a turquoise sea. Three UNESCO sites, three different worlds of antiquity.'],
    monuments: [
  ...
  },
  {
    ...
    hero: T + 'ghardaia-1.jpg', emblem: '../../assets/regions/em-mzab.svg', pat: "url('../../assets/regions/pat-mzab.svg')",
    ...
    intro: ['In a rocky valley on the edge of the Sahara, the Ibadi community built five fortified hill-towns around the year 1000 — Ghardaïa, Beni Isguen, Melika, Bou Noura and El Atteuf. Each climbs to a mosque whose minaret doubles as a watchtower.', 'The M’Zab is a masterpiece of desert design: terraced houses in ochre, white and blue, palm gardens fed by an ingenious water system, and a social order so intact that Le Corbusier came here to learn. It is lived heritage, not a monument.'],
    monuments: [
  ...
  },
  {
    ...
    hero: T + 'djanet-1.jpg', emblem: '../../assets/regions/em-sahara.svg', pat: "url('../../assets/regions/pat-sahara.svg')",
    ...
    intro: ['Beyond the Atlas, Algeria opens into the greatest desert on earth. The far south-east rises into the Tassili n’Ajjer — a sandstone plateau eroded into forests of stone, holding one of the richest galleries of prehistoric art in the world, some of it twelve thousand years old.', 'This is the country of the Kel Ajjer Tuareg, whose caravans once linked the Mediterranean to the Sahel. Around the oasis of Djanet, and in the dunes of the Tadrart, the desert is not a void to cross but a homeland — read, named and lived in.'],
    monuments: [
  ...
  },
  {
    ...
    hero: T + 'tlemcen-1.jpg', emblem: '../../assets/regions/em-tlemcen.svg', pat: "url('../../assets/regions/pat-tlemcen.svg')",
    ...
    intro: ['Tlemcen was the capital of a medieval kingdom and the most refined Andalusian city in the Maghreb — a place of mosques, madrasas and palaces whose carved plaster and tilework rival Granada. The ruined minaret of Mansourah still stands alone above the plain.', 'To the north, the port of Oran guards the western coast beneath the Spanish fort of Santa Cruz. Together they hold the Gharbi spirit — Andalusian music, the rai born in Oran’s cafés, and a coast that looks toward Spain.'],
    monuments: [
  ...
  },
  {
    ...
    hero: T + 'bejaia-3.jpg', emblem: '../../assets/regions/em-bejaia.svg', pat: "url('../../assets/regions/pat-bejaia.svg')",
    ...
    intro: ['Where the Djurdjura mountains meet the Mediterranean, the bay of Béjaïa opens under the green headland of Gouraya. Once the Hammadid capital and a great medieval port — it was here that Fibonacci learned the Arabic numerals he carried to Europe.', 'Behind the coast rises Kabylie, the Amazigh heartland: stone villages on the ridges, the snow-capped Djurdjura, and a culture of language, craft and fierce independence that has endured every empire.'],
    monuments: [
  ...
  },
  {
    ...
    hero: T + 'bousaada-6.jpg', emblem: '../../assets/regions/em-bousaada.svg', pat: "url('../../assets/regions/pat-bousaada.svg')",
    ...
    intro: ['Bou Saâda — “the place of happiness” — is the first true oasis south of the Tell, long the painters’ town where the light drew Étienne Dinet to settle and convert. Its palm groves, gorge and old ksar mark the edge of the desert.', 'Around it spread the high plateaus of the Hodna and the Saharan Atlas — pastoral country of the Ouled Naïl, of weekly markets, weaving and a horizon that opens at last onto the south.'],
    monuments: [
